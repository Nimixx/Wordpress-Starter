...
const { displayWelcome, createSectionHeader, displayInfo, displayWarning } = require('../utils/ui');
...
class Project {
  ...
  async createStructure(projectPath) {
    ...
    createSectionHeader(
      `Setting Up ${this.structureType.charAt(0).toUpperCase() + this.structureType.slice(1)} Structure`,
    );
