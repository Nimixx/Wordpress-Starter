...
class ClassicStructure extends Structure {
  ...
  async generateWithWpCli() {
    ...
    console.log(chalk.hex(catppuccin.text || '#CDD6F4')('    Edit wp-config.php to set your database credentials:'));
    console.log(chalk.hex(catppuccin.text || '#CDD6F4')('    Database name: ') + chalk.hex(catppuccin.green)('wordpress_db (update with your own)'));
    console.log(chalk.hex(catppuccin.text || '#CDD6F4')('    Database user: ') + chalk.hex(catppuccin.green)('root (update with your own)'));
    console.log(chalk.hex(catppuccin.text || '#CDD6F4')('    Database password: ') + chalk.hex(catppuccin.green)('root (update with your own)'));
    console.log(chalk.hex(catppuccin.text || '#CDD6F4')('    Database host: ') + chalk.hex(catppuccin.green)('localhost'));
  ...
  async generateManually() {
    ...
    console.log('\n');
    console.log(chalk.hex(catppuccin.yellow || '#FFC66D').bold('⚠️ WP-CLI wasn\'t used. You\'ll need to manually download WordPress.'));
