...
function displayClassicInfo() {
  ...
  const classicBox = boxen(
    chalk.hex(catppuccin.text).bold('Classic WordPress Structure\n\n') +
      ...
      chalk.hex(catppuccin.text)('Standard WordPress core files\n') +
      chalk.hex(catppuccin.blue)('• ') +
      chalk.hex(catppuccin.text)('Traditional wp-content folder structure\n') +
      chalk.hex(catppuccin.blue)('• ') +
      chalk.hex(catppuccin.text)('Standard wp-config.php configuration\n') +
      chalk.hex(catppuccin.blue)('• ') +
      chalk.hex(catppuccin.text)('Compatibility with most WordPress plugins and themes\n') +
      chalk.hex(catppuccin.blue)('• ') +
      chalk.hex(catppuccin.text)('Familiar environment for WordPress developers'),
    {
      padding: 2,
      margin: 0,
      borderStyle: 'round',
...
function createClassicStructure(projectPath) {
  ...
  try {
    ...
    console.log(
      chalk.hex(catppuccin.text)('    Edit wp-config.php to set your database credentials:'),
    );
    console.log(
    ...
    console.log(
      chalk.hex(catppuccin.text)('    Database host: ') + chalk.hex(catppuccin.green)('localhost'),
    );
